...
export default function Home() {
  ...
  return (
    <main className="min-h-screen w-full relative p-4 md:p-12 font-sans overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto h-[85vh] bg-[#F8F5E9] border-[3px] border-[#2d2d2d] rounded-xl shadow-[8px_8px_0_0_#2d2d2d] flex flex-col overflow-hidden relative z-10 transition-all">
        {/* Title Bar */}
        <div className="h-12 border-b-[3px] border-[#2d2d2d] bg-[#F8F5E9] flex items-center justify-between px-4 shrink-0 shadow-sm">
          ...
          <div className="flex-1 flex flex-col bg-white">
            ...
            <div className="p-4 border-t-[3px] border-[#2d2d2d] bg-white">
               <div className="w-full h-12 border-[3px] border-[#2d2d2d] rounded flex items-center px-4 bg-[#f8f5e9] shadow-[2px_2px_0_0_#2d2d2d] focus-within:shadow-[4px_4px_0_0_#2d2d2d] transition-shadow">
                  <input type="text" placeholder={`Message #${activeTab}`} className="flex-1 bg-transparent border-none outline-none font-bold text-[#2d2d2d] placeholder:text-[#2d2d2d]/50" disabled />
